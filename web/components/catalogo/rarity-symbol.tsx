...
> = {
  ...
  MEGA_ATTACK: { icon: Zap, count: 1, tone: "text-primary-ink" },
  GOLD_STAR: { icon: Star, count: 1, tone: "text-primary-ink" },
  GOLD_DOUBLE_STAR: { icon: Star, count: 2, tone: "text-primary-ink" },
  GOLD_TRIPLE_STAR: { icon: Star, count: 3, tone: "text-primary-ink" },
  GOLD_DIAMOND: { icon: Diamond, count: 1, tone: "text-primary-ink" },
  ACE_SPEC: { icon: Star, count: 1, tone: "text-pink-500" },
  GOLD_SPARKLE: { icon: Star, count: 1, tone: "text-primary-ink", fillTone: "fill-muted-foreground" },
  GOLD_DOUBLE_SPARKLE: { icon: Star, count: 2, tone: "text-primary-ink", fillTone: "fill-muted-foreground" },
