...
/**
 * Filtros de Pendências — mesmo padrão de debounce/URL-driven de
 * `LogAtualizacoesFiltros` (busca 300ms, `router.replace` dentro de
 * `startTransition`, toda troca de filtro zera `page`). Três filtros
 * pedidos por Fabrício: busca, Set, status (dentro do vocabulário fechado
 * PENDING/NOT_FOUND desta fila — "Todos" aqui significa os dois juntos,
 * nunca CONFIRMED/REJECTED).
 */
    ...
    <div className="flex flex-wrap items-center gap-2">
      <div className="relative min-w-[14rem] flex-1">
        ...
        <Input
          ...
          aria-label="Buscar em Pendências"
        />
      </div>
