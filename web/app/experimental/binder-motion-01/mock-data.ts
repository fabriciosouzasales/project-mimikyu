...
/**
 * Dados mockados do spike BINDER-MOTION-01 (pedido de Fabrício, 2026-08-28).
 * Reaproveita o mesmo catálogo de criaturas originais do Binder-First (ver
 * `binder-spike/mock-card-face.tsx` sobre por que são criaturas inventadas
 * e não Pokémon reais) só para dar volume visual a 6 spreads — sem
 * persistência, sem Inventory real, sem qualquer relação com dado de
 * catálogo/coleção verdadeiro.
 */
...
/** 4 padrões de preenchimento (9 slots) alternados por página — evita repetir o mesmo layout em todos os 12 spreads. */
