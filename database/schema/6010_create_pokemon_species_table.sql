...
-- físico confirmou colunas/tipos/defaults, PK, FK generation_id (ON
-- UPDATE/DELETE RESTRICT), UNIQUE(national_dex_number), os dois
-- CHECKs, índice ix_pokemon_species_generation_id e RLS habilitado
-- sem nenhuma policy. Testes comportamentais confirmaram rejeição de
-- national_dex_number <= 0, duplicado, e generation_id inválido; e
-- confirmaram que national_dex_number e generation_id permanecem
-- corrigíveis via UPDATE comum.
-- ================================================================
