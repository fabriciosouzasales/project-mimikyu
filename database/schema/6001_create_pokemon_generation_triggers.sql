...
-- físico confirmou os 3 triggers ativos (tgenabled='O'). Testes
-- comportamentais confirmaram rejeição de UPDATE em code e
-- ordinal_number com as mensagens exatas acima.
-- ================================================================
