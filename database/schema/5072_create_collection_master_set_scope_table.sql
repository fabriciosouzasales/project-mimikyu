...
aplicada via apply_migration; postcheck físico confirmou estrutura,
PK, FKs, RLS e policy idênticos a esta definição. Validado
funcionalmente em 5812 (114/114 PASS, zero resíduo).
