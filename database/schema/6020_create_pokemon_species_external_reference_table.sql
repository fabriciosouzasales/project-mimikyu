...
-- físico confirmou colunas/tipos/defaults, PK, FKs (CASCADE/RESTRICT
-- corretos), as duas UNIQUE, os três CHECKs, e RLS habilitado sem
-- nenhuma policy nem grant direto a anon/authenticated. Testes
-- comportamentais confirmaram rejeição de duplicidade (species,
-- source), duplicidade (source, external_id) e metadata não-objeto.
-- ================================================================
