...
Query.......: 5037 - Create archive_collection Function
Versão......: 1.2
Status......: CANÔNICA
...
- UPDATE ... WHERE collection.id = p_collection_id AND
  ...
  = 'ACTIVE' — única operação que decide atomicamente se a transição
  ACTIVE -> ARCHIVED ocorre;
...
IMPLEMENTATION-01, Fase 4): archive_collection() chamado duas vezes
seguidas na mesma Collection retorna exatamente o mesmo archived_at e
o mesmo updated_at nas duas chamadas — a segunda não realiza nenhum
UPDATE.
