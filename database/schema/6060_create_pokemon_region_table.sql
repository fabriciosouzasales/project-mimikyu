...
Data........: 2026-09-04 (staging em POKEMON-REGION-FOUNDATION-
               ...
               MODELING-01, ambos READ-ONLY, CLOSED; aplicado em
               2026-09-04 via POKEMON-REGION-FOUNDATION-PHYSICAL-
               IMPLEMENTATION-01)
...
-- PROMOTION-01) confirmou colunas/tipos/defaults, PK, a UNIQUE de
-- code, os dois CHECKs, RLS habilitado sem nenhuma policy
-- (rls_enabled_no_policy INFO no Security Advisor — esperado, mesmo
-- padrão das demais tabelas-raiz do módulo), e zero privilégio efetivo
-- (has_table_privilege) para anon/authenticated/service_role. Zero
-- linhas (sourcing permanece SUSPENSO). Validação comportamental e o
-- script completo de validação (6810) permanecem em
-- database/proposals/2026-09-04-pokemon-region-foundation/ como
