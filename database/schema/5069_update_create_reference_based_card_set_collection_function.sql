...
Query.......: 5069 - Update create_reference_based_card_set_collection Function
...
(Caso F — create_reference_based_card_set_collection() grava
completion_policy=STANDARD_SET, PASS).
