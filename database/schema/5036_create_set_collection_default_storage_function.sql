...
Query.......: 5036 - Create set_collection_default_storage Function
Versão......: 1.2
Status......: CANÔNICA
...
REVISION-01) — mesma correção e mesmo raciocínio de
...
update_collection_metadata() (Query 5035, ver seu cabeçalho): `id` no
WHERE colide com o parâmetro OUT de `RETURNS TABLE`. Corrigido
qualificando as três colunas do WHERE com `collection.`. Nenhuma
