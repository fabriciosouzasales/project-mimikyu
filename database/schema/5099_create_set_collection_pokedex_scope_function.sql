...
confirmou a função presente, EXECUTE revogado de PUBLIC/anon e
concedido a authenticated. Validado funcionalmente pela troca completa
de scope (FULL_REFERENCE→GENERATION_FILTERED→FULL_REFERENCE) de uma
Collection Pokédex real, em BEGIN/ROLLBACK. Zero resíduo. Esta foi a
última das 15 Queries aplicadas na sequência 5085→5099.
