...
Versão......: 1.2 (CONFIRMADO EXECUTADO E PROMOVIDO — renumerada de
               6123 para 6124 em RENUMBER-FIX-STAGING-01)
Status......: CONFIRMADO EXECUTADO
Autor.......: Fabrício Sales / Claude
Data........: 2026-09-05 (staging em COLLECTIONS-POKEDEX-FATIA-D-STAGING-01;
               revisado em PAUSE-SQL-DIRECT-AUDIT-01 (itens 2 e 3) e
               RENUMBER-FIX-STAGING-01 (renumerada de 6123 para 6124,
               para abrir espaço para a migration incremental de
               correção dos objetos já aplicados, que passa a ser 6123);
