...
Versão......: 1.2 (CONFIRMADO EXECUTADO E PROMOVIDO — renumerada de
               6124 para 6125 em RENUMBER-FIX-STAGING-01; corrigida
               incrementalmente por 6126 após bug funcional 42702)
Status......: CONFIRMADO EXECUTADO
Autor.......: Fabrício Sales / Claude
Data........: 2026-09-05 (staging em COLLECTIONS-POKEDEX-FATIA-D-STAGING-01;
               revisado em PAUSE-SQL-DIRECT-AUDIT-01 (itens 2 e 3,
               aplicada só a set_pokedex_position_primary_representative)
               e RENUMBER-FIX-STAGING-01 (renumerada de 6124 para 6125,
               para abrir espaço para a migration incremental dos
               objetos já aplicados (6123) e para remove_pokedex_
               position_assignment() (6124)); executada no banco real em
               IMPLEMENTATION-RESUME-02; corrigida incrementalmente por
               6126 (ON CONFLICT ambíguo, SQLSTATE 42702, encontrado em
               execução real na Seção 3 de 6830); promovida para
