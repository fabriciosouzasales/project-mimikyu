...
Origem......: database/proposals/2026-09-12-card-variants-printing-routing/
              2174_create_card_printing_external_mapping_guards.sql
...
REVISION HISTORY
-------------------------------------------------------------------------------
| 1.0 | **Criação dos cinco guards (2026-09-12).** Executada e confirmada no
        banco físico na PHASE A da frente CARD-VARIANTS — PRINTING-ROUTING.
