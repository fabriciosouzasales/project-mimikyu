...
Data........: 2026-09-04 (staging em POKEMON-REGION-FOUNDATION-
               ...
               aplicado em 2026-09-04 via POKEMON-REGION-FOUNDATION-
...
-- PROMOTION-01) confirmou main_region_id NOT NULL, sem UNIQUE, sem
-- índice dedicado (unindexed_foreign_keys INFO no Performance
-- Advisor — aceito por decisão explícita, proporcional ao volume),
-- e a FK simultaneamente confupdtype='r' AND confdeltype='r'
-- (pg_constraint). Comportamento N:1 comprovado com uma segunda
-- Generation distinta apontando para a mesma Region. main_region_id
-- permanece fora da lista de campos protegidos por
-- govern_pokemon_generation() (Query 6001, não reescrita). pokemon_
-- generation permanece com zero linhas (sourcing ainda SUSPENSO).
-- ================================================================
