...
-- PROMOTION-01) confirmou os três triggers ativos em pokemon_region e
-- EXECUTE revogado (has_function_privilege false) para anon/
-- authenticated nas três funções. Comportamento de imutabilidade de
-- id/code/created_at e normalização de code/canonical_name
-- re-verificados via função de sonda observável (RAISE NOTICE não é
-- visível pelas ferramentas de execução MCP usadas nesta rodada).
-- ================================================================
