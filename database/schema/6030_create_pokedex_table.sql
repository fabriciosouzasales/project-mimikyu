...
-- a UNIQUE de code, os dois CHECKs, RLS habilitado sem nenhuma policy,
-- e zero privilégio efetivo (has_table_privilege) para anon/
-- authenticated nas oito categorias de privilégio verificadas,
-- incluindo os revogados explicitamente acima. Validação comportamental
-- e o script completo de validação (6800) permanecem em
-- database/proposals/2026-09-04-pokedex-foundation/ como evidência
-- histórica — não promovidos para database/schema/.
-- ================================================================
