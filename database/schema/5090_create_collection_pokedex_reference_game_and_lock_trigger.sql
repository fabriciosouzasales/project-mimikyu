...
confirmou a trigger e a função presentes, EXECUTE revogado de
PUBLIC/anon/authenticated. Validado funcionalmente: rejeição confirmada
de Pokédex Reference numa Collection do Game Lorcana (Game gate
operante), dentro de BEGIN/ROLLBACK. Zero resíduo.
