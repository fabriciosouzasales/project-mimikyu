...
aplicada via apply_migration; postcheck físico confirmou trigger
`DEFERRABLE INITIALLY DEFERRED` e GRANTs idênticos a esta definição.
Validado funcionalmente em 5812 (114/114 PASS, zero resíduo).
