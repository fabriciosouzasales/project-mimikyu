...
Data........: 2026-09-05 (staging em
               ...
               database/schema/ em ...-CANONICAL-CLOSEOUT-01 — corpo SQL
               byte-idêntico ao executado, apenas cabeçalho Status/Versão/
               Data atualizados. Reconcilia o estado final real de
               catalog_admin_action_log: 29 actions / 11 entity_types /
               11 ramos de action_entity_match)
...
IMPORTANTE (nota de promoção, CANONICAL-CLOSEOUT-01): 2010 permanece no
repositório como a migration de CRIAÇÃO original da tabela — não deve
ser lida como refletindo o estado atual das três CHECKs. Esta Query 2159
é a migration incremental que efetivamente reconcilia o estado físico
real (29 actions / 11 entity_types / 11 ramos) — qualquer leitor que
precise saber "quais actions/entity_types são válidos hoje" deve somar
2010 + 2159, nunca usar 2010 isoladamente como baseline atual.
