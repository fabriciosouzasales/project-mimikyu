...
Origem......: database/proposals/2026-09-12-card-variants-printing-routing/
              2175_seed_card_printing_external_mappings.sql
...
REVISION HISTORY
-------------------------------------------------------------------------------
| 1.0 | **Carga inicial dos 5 mappings / 6 vínculos (2026-09-12).** Executada
        e confirmada no banco físico na PHASE A da frente CARD-VARIANTS —
        PRINTING-ROUTING. Promovida de database/proposals/ para
        database/seeds/ em 2026-09-13 (TECHNICAL-CLOSEOUT-PROMOTION-01). O
        SQL executável permanece idêntico ao artefato executado; só o
        cabeçalho registra o estado final. A proposal original é preservada
        como histórico. |
===============================================================================
*/
