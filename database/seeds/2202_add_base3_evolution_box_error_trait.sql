...
Data........: 2026-09-18
Executado...: 2026-09-18 02:51:27 UTC, via execute_sql DIRETO (MCP Supabase),
              projeto qjfutqujxrbzgrtkpgkg.
              SEM ENTRADA DE LEDGER — esta Query NÃO consta em
              supabase_migrations.schema_migrations, e isso é correto: foi
              execução direta, não apply_migration. Nenhuma entrada de
              migration foi fabricada para encobrir isso.
              Prova independente da execução, por dado e não por cabeçalho:
              public.card_printing_trait.code = 'EVOLUTION_BOX_ERROR' com
              created_at = 2026-09-18 02:51:27.65747+00 — exatamente o
              timestamp acima.
Promovida...: 2026-09-18, BULK-STP-01-CANONICAL-RECONCILIATION-IMPLEMENTATION-01
Origem......: database/proposals/2026-09-18-base3-editorial-convergence/
