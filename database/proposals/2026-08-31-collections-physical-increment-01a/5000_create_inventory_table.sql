...
Query.......: 5000 - Create Inventory Table (PROPOSTA)
Versão......: 1.0
...
Supabase. Numeração 5000 é provisória (milhar 5000-5999 sugerido
para Collections, nunca formalmente reservado — ver STD-001 Seção 10,
regra de não pré-reservar milhares). Confirmar numeração definitiva
no momento da reconciliação para database/schema/ e
database/migrations/, após execução real autorizada.
================================================================
*/
