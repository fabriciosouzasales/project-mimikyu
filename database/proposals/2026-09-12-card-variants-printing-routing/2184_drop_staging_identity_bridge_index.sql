...
===============================================================================
   ...
   NÃO aplicar antes da PHASE D estar concluída e confirmada.

   Este é o PONTO DE NÃO RETORNO do rollout. Depois dele, uma linha
   VALID sem a chave printing_profile_id deixa de ser possível no banco.

   O script se RECUSA a rodar sem autorização explícita de fase
   (GUARD 0) e sem as seis precondições provadas (GUARD 1..6).
===============================================================================
Projeto.....: Project Mimikyu
Query.......: 2184 - Finalize Staging Identity and Drop Compatibility Bridge
Versão......: 2.0
Status......: PROPOSTA — NÃO EXECUTADA — DEFERRED (PHASE E)
