...
Pós-condição esperada (provada em 6821):
...
- Dados/contagens/runs preservados (nenhum DML nesta migration).
...
contra nenhum banco nesta rodada. Nenhuma alegação de sucesso é feita aqui
— apenas a lógica de correção, pronta para execução futura mediante
