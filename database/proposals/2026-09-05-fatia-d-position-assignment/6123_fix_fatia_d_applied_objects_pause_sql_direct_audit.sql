...
Query.......: 6123 - Fix Fatia D Already-Applied Objects (PAUSE SQL Direct
               ...
               executada)
Versão......: 1.1 (STAGING — NÃO EXECUTADO — renumerada de 6125 para 6123
               em COLLECTIONS-POKEDEX-FATIA-D-RENUMBER-FIX-STAGING-01,
               para refletir a ordem cronológica real: esta correção
               precisa ser aplicada ANTES de remove_pokedex_position_
               assignment() e das RPCs de Primary Representative — que
               por isso passam a ser 6124 e 6125, respectivamente)
Status......: PROPOSTO
Autor.......: Fabrício Sales / Claude
Data........: 2026-09-05 (staging em resposta a
               COLLECTIONS-POKEDEX-FATIA-D-IMPLEMENTATION-01 /
               PAUSE-SQL-DIRECT-AUDIT-01)
