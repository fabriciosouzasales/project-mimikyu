...
Query.......: 5038 - Create reactivate_collection Function (PROPOSTA)
Versão......: 1.2
Status......: PROPOSTA — NÃO EXECUTADA
Autor.......: Fabrício Sales / Claude
Data........: 2026-08-31 (COLLECTIONS-PHYSICAL-INCREMENT-02B-MODELING-01
               → -REVISION-01 → -FINAL-01 → -STAGING-REVISION-01, item 4
               → -IMPLEMENTATION-01, Fase 4 — correção preventiva de
               referência ambígua, espelhando 5037)
...
- UPDATE ... WHERE id = p_collection_id AND owner_user_id = auth.uid()
  AND lifecycle_status = 'ARCHIVED' — única operação que decide
  atomicamente se a transição ARCHIVED -> ACTIVE ocorre;
