...
Query.......: 5035 - Create update_collection_metadata Function (PROPOSTA)
Versão......: 1.2
Status......: PROPOSTA — NÃO EXECUTADA
Autor.......: Fabrício Sales / Claude
Data........: 2026-08-31 (COLLECTIONS-PHYSICAL-INCREMENT-02B-MODELING-01
               → -REVISION-01 → -FINAL-01 → -STAGING-REVISION-01, item 1
...
REVISION-01, item 1). A versão 1.0 fazia SELECT lifecycle_status ->
depois UPDATE sem repetir a checagem no WHERE — uma janela real entre
as duas statements onde archive_collection() concorrente poderia
arquivar a Collection depois da leitura e antes da escrita, permitindo
esta função editar metadata de uma Collection já ARCHIVED. Corrigido:
...
Contrato externo preservado — mesma assinatura
(uuid, text, text) e mesmo RETURNS TABLE(id, name, description,
updated_at) da versão 1.0. Apenas a implementação interna mudou.
