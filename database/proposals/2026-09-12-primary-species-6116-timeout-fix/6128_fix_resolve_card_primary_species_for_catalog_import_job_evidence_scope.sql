...
ESTE ARQUIVO E EVIDENCIA HISTORICA DA RODADA DE STAGING.
A fonte canonica e database/schema/6128_fix_resolve_card_primary_species_
for_catalog_import_job_evidence_scope.sql. Os cabecalhos das duas copias
divergem de proposito (cada uma declara o proprio papel); o que precisa ser
byte-identico entre proposal, schema e o objeto LIVE e o CORPO SQL
