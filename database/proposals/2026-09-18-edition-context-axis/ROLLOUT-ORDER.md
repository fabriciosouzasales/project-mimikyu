...
| 12-A | **`2217` EXPAND** · **PRÓXIMO ESTÁGIO — NÃO EXECUTADA**, exige mandato explícito de Fabrício · **pré-requisito `2224` SATISFEITO** (LIVE VALIDATED em 2026-09-22) — cria `write_card_variant` de **7 args** e **PRESERVA** a de 6. Não dropa nada | duas assinaturas coexistem; o confirm antigo segue chamando a de 6 | **não** — aditivo puro. Nenhum caller aponta para assinatura ausente |
