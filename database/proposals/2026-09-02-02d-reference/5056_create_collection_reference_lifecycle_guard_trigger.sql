...
Query.......: 5056 - Create Collection Reference Lifecycle Guard Trigger (PROPOSTA)
Versão......: 1.1 (endurecida em COLLECTIONS-PHYSICAL-INCREMENT-02D-
               STAGING-REVISION-01, item 1 — ver nota de blocker
               abaixo; arquivo nunca foi CANÔNICO, então esta é uma
               revisão do próprio staging, não um CREATE OR REPLACE
               sobre algo já executado)
...
passar. Este comportamento PRECISA ser um caso de teste real na
bateria de validação (Query 5808, Casos T/U) — não é declarado
correto sem prova.
