...
Query.......: 5042 - Create Collection Allocation Integrity Trigger (PROPOSTA)
Versão......: 1.1
Status......: PROPOSTA — NÃO EXECUTADA
Autor.......: Fabrício Sales / Claude
Data........: 2026-09-01 (COLLECTIONS-PHYSICAL-INCREMENT-02C-MODELING-01
               → -REVISION-01, item 2 — correção de Physical Card sem
               Inventory)
...
Estatement-level com transition table (REFERENCING NEW TABLE, FOR
EACH STATEMENT) — desenho aprovado desde COLLECTIONS-PHYSICAL-
INCREMENT-02C-MODELING-01, item 2: evita FOR EACH ROW num lote de até
500 linhas (allocate_physical_cards_to_collection(), Query 5046).
Duas triggers separadas (INSERT e UPDATE) chamando a mesma função —
nenhuma RPC desta rodada faz UPDATE em collection_allocation, mas a
trigger de UPDATE cobre defensivamente qualquer caminho futuro que
venha a fazê-lo (mesmo raciocínio de 5041).
...
inventory referenciado sempre existente (não há caminho físico para
"Inventory não existir" com a coluna preenchida — texto do pedido
"ou Inventory não existir" já coberto por essa garantia estrutural,
...
todas sob RLS restrita ao próprio owner.
