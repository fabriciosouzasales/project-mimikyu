...
Query.......: 5045 - Create Collection started_at From First Allocation Trigger (PROPOSTA)
Versão......: 1.0
...
qualquer RPC escrever NOW() diretamente. Estatement-level (AFTER
...
própria trigger e por 5044 (started_at só é NULL enquanto a Collection
não tem nenhuma Collection Allocation, e nunca volta a NULL depois de
definido — 5047 nunca reseta), MIN sobre new_table é equivalente a
MIN sobre toda collection_allocation da Collection nesse momento: se
started_at está NULL, este é necessariamente o primeiro lote de
Allocations dela.
...
5044 (validate_collection_structural_identity()), que reconfirma
independentemente o valor antes de aceitar a escrita — ver 5044 para o
detalhamento dessa segunda camada.
