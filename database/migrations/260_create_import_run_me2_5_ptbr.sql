-- Project Mimikyu
-- Query 260 - Create Import Run ME2.5 (pt-BR)
...
-- completo.
--
-- Réplica da Query 259 (ME2, pt-BR) para a ME2.5 — mesmo `card_set_id`/
-- `asset_source_id` da Query 256 (ME2.5, en).
