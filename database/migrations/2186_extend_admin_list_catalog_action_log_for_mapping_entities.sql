...
Origem......: database/proposals/2026-09-12-card-variants-printing-routing/
              2186_extend_admin_list_catalog_action_log_for_mapping_entities.sql
...
-------------------------------------------------------------------------------
Esta definição permanece LIVE: 12 branches de entity_label. O arquivo é
MIGRATION porque altera uma função já existente (Query 2127); a forma
canônica de admin_list_catalog_action_log() continua sendo a 2127, que
está desatualizada em relação ao LIVE — a divergência documentada acima
permanece em aberto e deve ser resolvida em rodada própria de
reconciliação canônica.

-------------------------------------------------------------------------------
REVISION HISTORY
-------------------------------------------------------------------------------
| 1.0 | **Branches de entity_label para Mapeamentos e Pokédex (2026-09-12).**
        Superconjunto defensivo + guard anti-drift por extração de literais
        `WHEN '...'`. Executada e confirmada no banco físico na PHASE B da
