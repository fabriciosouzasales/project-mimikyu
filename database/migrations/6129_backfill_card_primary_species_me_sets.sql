...
Data........: 2026-09-12
Executado...: 2026-09-12, como `postgres` no SQL Editor. Guards G0/G0b/G0c,
               G1, G2/G2b/G2c, G3/G3b/G3c, G4, G5/G5b, G6, G7, G8, G9/G9b e
               G10 passaram; asserts A1-A10 passaram; COMMIT efetivado.
               Resultado: 751 Cards resolvidas AUTOMATIC_DEXID;
               card_primary_species 16.657 -> 17.408.
Mandato.....: PRIMARY-SPECIES-ME-SOURCING-01 — BACKFILL-GATE-A-REVISION-01
               (autoria) / BACKFILL-SYNTAX-CORRECTION-01 (correcao do literal
               JSONB) / BACKFILL-01-RETRY (execucao) /
               DOCUMENTATION-CLOSEOUT-01 (promocao para migrations/)
...
database/proposals/2026-09-12-primary-species-me-sourcing/ — a unica
diferenca esta neste cabecalho documental. Transformacao de DADOS, nao
definicao canonica de schema: por isso migrations/ e nao schema/.
