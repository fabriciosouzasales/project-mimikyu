...
Query.......: 3001 - Create Pricing Source Trigger
Versão......: 1.0
Status......: CANÔNICA
...
public.pricing_source, reaproveitando a função já existente
public.set_updated_at() (mesmo padrão de todas as demais tabelas
do projeto).
