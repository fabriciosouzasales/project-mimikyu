...
Origem......: database/proposals/2026-09-12-card-variants-printing-routing/
              2178_extend_internal_write_card_variant_for_printing.sql
...
-------------------------------------------------------------------------------
O DEFAULT NULL de p_printing_profile_id introduzido aqui foi REMOVIDO pela
Query 2187 (PHASE E), que torna o parâmetro obrigatório. Por isso este
arquivo é MIGRATION, não CANÔNICA: representa um estado intermediário do
rollout. A forma canônica de internal.write_card_variant() será
consolidada na Query 2143 na rodada CANONICAL-RECONCILIATION-01.

-------------------------------------------------------------------------------
REVISION HISTORY
-------------------------------------------------------------------------------
| 1.0 | **Extensão da assinatura para Printing (2026-09-12).** Executada e
