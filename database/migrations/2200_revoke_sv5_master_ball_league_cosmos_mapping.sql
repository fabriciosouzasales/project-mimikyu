...
Versão......: 1.1
Status......: MIGRATION / CORREÇÃO DE DADO / CONFIRMADO EXECUTADO / LIVE
...
Executado...: 2026-09-16, via apply_migration (MCP Supabase), projeto
              qjfutqujxrbzgrtkpgkg. Ledger: 20260916212542 /
              revoke_sv5_master_ball_league_cosmos_mapping
              ATENÇÃO: o nome registrado no ledger NÃO carrega o prefixo
              numérico 2200, divergindo da convenção NNNN_nome de todas as
              demais. Irreversível — registrado aqui como nota histórica.
Reclassif..: 2026-09-18, BULK-STP-01-CANONICAL-RECONCILIATION-IMPLEMENTATION-01
Canônica....: NENHUMA. Correção de dado não entra em instalação limpa —
              um banco novo não revoga um mapeamento que nunca criou.
