...
Origem......: database/proposals/2026-09-12-card-variants-printing-routing/
              2180_reconcile_variant_type_mapping_writers_to_residual.sql
...
-------------------------------------------------------------------------------
Esta definição permanece LIVE. O arquivo é classificado como MIGRATION
porque sucede a Query 2150 (também LIVE até esta alteração) alterando uma
função já existente; a forma canônica de
admin_resolve_catalog_variant_import_mapping() continua sendo a Query 2150,
que será consolidada em rodada própria de reconciliação canônica.

-------------------------------------------------------------------------------
REVISION HISTORY
-------------------------------------------------------------------------------
| 1.0 | **Writers de mapping migrados para a assinatura residual
        (2026-09-12).** Fecha o BLOCKER B3. Executada e confirmada no banco
        ...
        permanece idêntico ao artefato executado; só o cabeçalho registra o
        estado final. A proposal original é preservada como histórico. |
===============================================================================
*/
