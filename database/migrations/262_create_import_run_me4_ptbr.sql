-- Project Mimikyu
-- Query 262 - Create Import Run ME4 (pt-BR)
...
-- completo — última coleção da Fase 2, encerrando a implantação do
-- Catálogo Editorial.
--
-- Réplica da Query 259 (ME2, pt-BR) para a ME4 — mesmo `card_set_id`/
-- `asset_source_id` da Query 258 (ME4, en).
