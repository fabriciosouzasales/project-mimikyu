-- Project Mimikyu
-- Query 261 - Create Import Run ME3 (pt-BR)
...
-- completo.
--
-- Réplica da Query 259 (ME2, pt-BR) para a ME3 — mesmo `card_set_id`/
-- `asset_source_id` da Query 257 (ME3, en).
