...
| **Status** | Aprovado (decisão declarada como definitiva pela sessão pareada — "chegamos ao momento de congelar a arquitetura" — nenhuma implementação real ocorreu ainda; ver `../06-pipeline-importacao.md`, seção "Sprint B3", para o estado de implementação) |
| **Data** | 2026-07 |
