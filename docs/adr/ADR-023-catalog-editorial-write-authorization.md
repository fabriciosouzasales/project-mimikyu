...
- `Game`/`Expansion`/`Card Set` seguem sem caminho de desativação por UI — se isso se tornar necessário, é uma decisão futura própria, fora deste ADR.
