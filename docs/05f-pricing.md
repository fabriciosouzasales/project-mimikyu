...
- [ ] primeira taxa real cadastrada — depende de execução real do script por Fabrício localmente (`deno run`, sem restrição de rede/API key neste ambiente de agente — ver "Incremento P9" para o status exato do piloto).
