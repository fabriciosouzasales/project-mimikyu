...
- **novo, Sprint B3.7**: um novo `asset_import_run` para `ME1` (ou outra coleção suportada) ainda não foi criado — próximo passo direto para a primeira resposta real de ponta a ponta da TCGdex através da Edge Function.
