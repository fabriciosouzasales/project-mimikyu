...
- **novo, Sprint B3.5**: não confirmado se o Dashboard do Supabase estava servindo a versão mais recente do `index.ts` durante os testes desta revisão — marcador de verificação (`version: "TESTE-123456"`) proposto, não aplicado.
