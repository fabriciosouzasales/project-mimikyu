...
| Documento | Resumo |
|---|---|
| [`development/HANDOFF-2026-08-18.md`](development/HANDOFF-2026-08-18.md) | Handoff vigente — encerramento formal do **Incremento P12 — Exibição de Preços no Frontend** e, na mesma data e em ciclos seguintes, **P13.1–P13.4/P13 — Orquestração Programada de Pricing** (Cron/Vault/Edge Function `ptax-fx-refresh`, formalmente encerrado em 2026-08-19) e **P14.1–P14.4.4 — ativação comercial da JustTCG, descoberta+persistência em lotes e expansão de cobertura por ondas com matching canônico por Set+número** (reparo real de 53 mappings promovidos, migrations `3920`/`3921`). **P14 permanece em andamento**; próximo passo real P14.4.3 (ondas seguras remanescentes). Correção de autenticação `/login` fora do escopo. |
