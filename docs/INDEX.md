...
| Documento | Resumo |
|---|---|
| [`development/HANDOFF-2026-08-18.md`](development/HANDOFF-2026-08-18.md) | Handoff vigente — encerramento formal do **Incremento P12 — Exibição de Preços no Frontend**: migrations `3903`/`3904`, contratos frontend (pill/popover nos três grids), 14 critérios de aceite/evidências aprovados por Fabrício, commits `6324b66`/`0dad413` sincronizados com `origin/main`. Registrado: PTAX pode ser automatizada; JustTCG inativa até contratação comercial; visualização de preços nunca chama a JustTCG; sincronização/consulta desacopladas. Próximo incremento recomendado: **P13 — Orquestração Programada de Pricing**. Correção de autenticação `/login` fora do escopo. Ciclo exclusivamente documental. |
