...
Próxima frente do projeto **não é mais** este contrato — ver `docs/ROADMAP.md`/handoff vigente para a retomada de Collections (Fatias B e C já `CONFIRMADO EXECUTADO`/`CLOSED` desde 2026-09-05; Pokédex Position Assignment/Primary Representative — Fatias D/E — permanecem `PHYSICALLY NOT STARTED`, fora do escopo deste Initial Load).
