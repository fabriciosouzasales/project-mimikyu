...
Próxima frente do projeto **não é mais** este contrato — ver `docs/ROADMAP.md`/handoff vigente para a retomada de Collections (Fatias B e C `CONFIRMADO EXECUTADO`/`CLOSED` desde 2026-09-05; Fatia D — Pokédex Position Assignment/Primary Representative — `IMPLEMENTED / VALIDATED / CLOSED` desde 2026-09-06; Fatia E — REFERENCE_POSITION Completion — `IMPLEMENTED / LIVE / VALIDATED / PERFORMANCE-MEASURED / CLOSED` desde 2026-09-06; **todas fora do escopo deste Initial Load**, que continua limitado à aquisição do Pokémon Catalog via PokéAPI).
...
- Pokédex Position Assignment, Primary Representative (Fatias D/E do Pokédex — `LDM-175`–`185`). Card → Primary Species (Fatia C) saiu desta lista em 2026-09-05 — `CONFIRMADO EXECUTADO`, ver `docs/05d-colecoes-e-usuarios.md`.
