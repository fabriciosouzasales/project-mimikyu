...
| Card Category | Classifica a natureza da Card (Pokémon, Trainer, Energy). Nem toda Card representa um Pokémon. Taxonomia completa (subfamílias de Trainer) ainda em aberto. |
...
| Pokémon | Espécie/personagem Pokémon referenciada por Cards de Card Category Pokémon. Entidade de referência reutilizada entre Sets — não uma Card em si. |
