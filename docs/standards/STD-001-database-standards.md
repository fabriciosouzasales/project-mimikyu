...
Comprometido no Incremento P1 — Fundação Física de Pricing (2026-08-16), cobrindo a implementação de `ADR-029-pricing-domain-model.md` — ver `docs/05f-pricing.md` para o modelo lógico e físico completo do domínio. Estendido no Incremento P2 — Correspondência Externa de Pricing (2026-08-16, mesmo dia).

Dentro de `3000–3699` (estrutura), cinco entidades foram implementadas até o momento:
...
As demais cinco entidades do domínio (`pricing_product`, `pricing_fx_rate`, `pricing_observation`, `pricing_sync_run`, `pricing_sync_run_call`) permanecem `Proposto, ainda não executado` — ver `docs/05f-pricing.md` para a distribuição numérica candidata de cada uma.
