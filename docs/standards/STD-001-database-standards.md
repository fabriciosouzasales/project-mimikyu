...
As demais três entidades do domínio (`pricing_product`, `pricing_fx_rate`, `pricing_observation`) permanecem `Proposto, ainda não executado` — ver `docs/05f-pricing.md` para a distribuição numérica candidata de cada uma.
