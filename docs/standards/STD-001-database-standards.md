...
A única entidade restante do domínio (`pricing_observation`) permanece `Proposto, ainda não executado` — ver `docs/05f-pricing.md` para a distribuição numérica candidata.
