...
|[STD-004](STD-004-frontend-standards.md)|Frontend Standards|Aprovado|
...
|2.1|Adicionado `STD-004` (Frontend Standards, 2026-07-30) — padrões de navegação, composição de página, superfície (`Card`, absorvendo `Panel`), formulários (Dialog), tabelas e feedback do frontend web, formalizados na sessão de correção e sincronização de frontend (Ciclos A-D, tela piloto Expansões). Área identificada como pendente desde a auditoria de 26/07 (`docs/README.md`, revisão `1.55`). |
